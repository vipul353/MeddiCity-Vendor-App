...
class AuthRepo {
  ...
  Future<Response> login1({String phone,String type}) async {
    return await apiClient.postData(AppConstants.LOGIN1_URI, {"phone": phone,'vendor_type': type});
  }
  ...
  Future<Response> registerRestaurant(
      StoreBody store, XFile logo, XFile cover, XFile pickedSignature) async {
    return apiClient.postMultipartData(
      ...
      [
        ...
        MultipartBody('signatre', pickedSignature)
      ],
    );
  }
