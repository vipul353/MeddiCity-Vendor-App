...
class AuthController extends GetxController implements GetxService {
  ...
  XFile get pickedSignature => _pickedSignature;
  ...
  Future<ResponseModel> login1(String phone,String type) async {
    _isLoading = true;
    update();
    Response response = await authRepo.login1(phone: phone);
    ResponseModel responseModel;
    if (response.statusCode == 200) {
  ...
  void pickImageForReg(bool isLogo, bool isCover, bool isRemove) async {
    if (isRemove) {
      _pickedLogo = null;
      _pickedCover = null;
