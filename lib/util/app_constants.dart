...
class AppConstants {
  static const String APP_NAME = 'MEDDCITY VENDOR APP';
  static const double APP_VERSION = 1.8;

  static const String BASE_URL = 'https://kpsbakeryhub.com/medi';
  // static const String BASE_URL = 'http://192.168.1.39/medicity';
  static const String CONFIG_URI = '/api/v1/config';
  static const String LOGIN_URI = '/api/v1/auth/vendor/login';
  static const String LOGIN1_URI = '/api/v1/auth/vendor/login_with_otp';
  static const String VERIFY_PHONE_URI = '/api/v1/auth/vendor/verify-otp';
