...
class RouteHelper {
  ...
  static String getVerificationRoute(String number ,String page,String type) {
    return '$verification?page=$page&number=$number&type=type';
  }
 // static String getVerificationRoute(String number) => '$verification?number=$number';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: verification, page: () => VerificationScreen(number: Get.parameters['number'],type: Get.parameters['type'])),
