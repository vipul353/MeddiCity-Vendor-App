...
class VerificationScreen extends StatefulWidget {
  final String number;
  final String type;
  VerificationScreen({@required this.number,@required this.type});
        ...
        child: Center(child: SizedBox(width: 1170, child: GetBuilder<AuthController>(builder: (authController) {
          return Column(children: [
            ...
            Get.find<SplashController>().configModel.demo ? Text(
              ...
              TextSpan(text: ' ${widget.number}', style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyText1.color)),
            ])),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              TextButton(
                onPressed: _seconds < 1 ? () {
                  authController.login1(_number,"").then((value) {
                    if (value.isSuccess) {
                      _startTimer();
            ...
            authController.verificationCode.length == 4 ? !authController.isLoading ? CustomButton(
              ...
              onPressed: () {
                print("NUMBER"+_number);
                authController.verifyPhone(_number, "").then((value){
